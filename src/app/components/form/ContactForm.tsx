...
const ContactForm = () => {
  return (
    <form className='bg-Theme-black w-96 lg:w-full h-fit flex flex-col items-center justify-center relative top-0 rounded-md p-8'>
        ...
        <p className='flex flex-col items-center justify-center'><div className='text-2xl font-extrabold'>Office Time</div><div>Morning 08:00 AM to 10:00 AM</div><div>Evening 07:00 PM to 09:00 PM</div></p>
        </div>
    </form>
  )
}
