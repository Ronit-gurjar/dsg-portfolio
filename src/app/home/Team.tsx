...
const Team = () => {
  return (
    <div className="bg-Theme-black w-fit h-fit flex flex-col items-center justify-center gap-8 lg:p-8 rounded-lg">
        <div>
            <h1 className="text-4xl text-Theme-cream text-center underline underline-offset-4 font-serif p-4">Team</h1>
            <h1 className="text-2xl text-white"><strong>Meet our vibrant team</strong></h1>
        </div>
        ...
        <div>
            <p className="p-4 text-2xl text-center text-white mt-2">
